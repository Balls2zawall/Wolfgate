...
wf-shuttle-console-lift-ratio = Lift { $ratio } : 1
...
wf-flight-lift-warning = Landing thrusters rate { $ratio } of this hull's weight. Confirm the descent to go down anyway.
...
wf-landing-kit-converted = The thruster is re-canted for landing.
